...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const shortcuts: Shortcuts = {
    ...
    statusView: useCommandShortcut("ds-code.status"),
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public ds-code.ai link",
  ...
  "Create {highlight}ds-code.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Create a plugin to prevent DS Code from reading sensitive files",
  "Use {highlight}ds-code run{/highlight} for non-interactive scripting",
  "Use {highlight}ds-code --continue{/highlight} to resume the last session",
  "Use {highlight}ds-code run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ds-code serve{/highlight} for headless API access to DS Code",
  "Use {highlight}ds-code run --attach{/highlight} to connect to a running server",
  "Run {highlight}ds-code upgrade{/highlight} to update to the latest version",
  "Run {highlight}ds-code auth list{/highlight} to see all configured providers",
  "Run {highlight}ds-code agent create{/highlight} for guided agent creation",
  "Use {highlight}/ds-code{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}ds-code github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/ds-code fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}ds-code debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/ds-code{/highlight} in a container",
  "Use {highlight}/connect{/highlight} with DS Code Zen for curated, tested models",
